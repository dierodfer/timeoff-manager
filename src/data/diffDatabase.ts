...
// Como conjunto, no como lista: terminateEmployee() cambia el `end` de un periodo conservando
// su id, así que el orden no importa.
...
// Por id a través de TODAS las solicitudes anteriores, no solicitud a solicitud: separar un día
// mueve el hilo a una solicitud con otro id (ver CLAUDE.md, «El modo empresa»).
 ...
 * que `supabaseRepository.save()` debe escribirlo. Ver CLAUDE.md, «El modo empresa».
 */
